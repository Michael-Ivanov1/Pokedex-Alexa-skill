...
class PokemonType:
    ...
    # Splitting up damage from and damage to to save processing power
    # A call to just double_damage_from won't work, you have to factor in double typing and the changes it brings
...
y = Move("tail-whip", "diamond-pearl")
